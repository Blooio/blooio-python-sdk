...
class TestMembers:
    ...
    def test_method_list(self, client: Blooio) -> None:
        member = client.groups.members.list(
    ...
    def test_raw_response_list(self, client: Blooio) -> None:
        response = client.groups.members.with_raw_response.list(
            group_id="grp_abc123def456",
        )
    ...
    def test_streaming_response_list(self, client: Blooio) -> None:
        with client.groups.members.with_streaming_response.list(
            group_id="grp_abc123def456",
        ) as response:
    ...
    def test_path_params_list(self, client: Blooio) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `group_id` but received ''"):
            client.groups.members.with_raw_response.list(
                group_id="",
            )
    ...
    def test_method_add(self, client: Blooio) -> None:
        member = client.groups.members.add(
            group_id="grp_abc123def456",
    ...
    def test_raw_response_add(self, client: Blooio) -> None:
        response = client.groups.members.with_raw_response.add(
            group_id="grp_abc123def456",
            contact_id="+15551234567",
        )
    ...
    def test_streaming_response_add(self, client: Blooio) -> None:
        with client.groups.members.with_streaming_response.add(
            group_id="grp_abc123def456",
            contact_id="+15551234567",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_add(self, client: Blooio) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `group_id` but received ''"):
            client.groups.members.with_raw_response.add(
                group_id="",
                contact_id="+15551234567",
            )
    ...
    def test_method_remove(self, client: Blooio) -> None:
        member = client.groups.members.remove(
    ...
    def test_raw_response_remove(self, client: Blooio) -> None:
        response = client.groups.members.with_raw_response.remove(
            contact_id="%2B15551234567",
            group_id="grp_abc123def456",
        )
    ...
    def test_streaming_response_remove(self, client: Blooio) -> None:
        with client.groups.members.with_streaming_response.remove(
            contact_id="%2B15551234567",
            group_id="grp_abc123def456",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_remove(self, client: Blooio) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `group_id` but received ''"):
            client.groups.members.with_raw_response.remove(
                contact_id="%2B15551234567",
                group_id="",
            )
...
class TestAsyncMembers:
    ...
    async def test_method_list(self, async_client: AsyncBlooio) -> None:
        member = await async_client.groups.members.list(
            group_id="grp_abc123def456",
        )
        assert_matches_type(MemberListResponse, member, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncBlooio) -> None:
        response = await async_client.groups.members.with_raw_response.list(
            group_id="grp_abc123def456",
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncBlooio) -> None:
        async with async_client.groups.members.with_streaming_response.list(
            group_id="grp_abc123def456",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list(self, async_client: AsyncBlooio) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `group_id` but received ''"):
            await async_client.groups.members.with_raw_response.list(
                group_id="",
            )
    ...
    async def test_method_add(self, async_client: AsyncBlooio) -> None:
        member = await async_client.groups.members.add(
            group_id="grp_abc123def456",
            contact_id="+15551234567",
        )
        assert_matches_type(MemberAddResponse, member, path=["response"])
    ...
    async def test_raw_response_add(self, async_client: AsyncBlooio) -> None:
        response = await async_client.groups.members.with_raw_response.add(
            group_id="grp_abc123def456",
            contact_id="+15551234567",
        )
    ...
    async def test_streaming_response_add(self, async_client: AsyncBlooio) -> None:
        async with async_client.groups.members.with_streaming_response.add(
            group_id="grp_abc123def456",
            contact_id="+15551234567",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_add(self, async_client: AsyncBlooio) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `group_id` but received ''"):
            await async_client.groups.members.with_raw_response.add(
                group_id="",
                contact_id="+15551234567",
            )
    ...
    async def test_method_remove(self, async_client: AsyncBlooio) -> None:
        member = await async_client.groups.members.remove(
            contact_id="%2B15551234567",
            group_id="grp_abc123def456",
        )
        assert_matches_type(MemberRemoveResponse, member, path=["response"])
    ...
    async def test_raw_response_remove(self, async_client: AsyncBlooio) -> None:
        response = await async_client.groups.members.with_raw_response.remove(
            contact_id="%2B15551234567",
            group_id="grp_abc123def456",
        )
    ...
    async def test_streaming_response_remove(self, async_client: AsyncBlooio) -> None:
        async with async_client.groups.members.with_streaming_response.remove(
            contact_id="%2B15551234567",
            group_id="grp_abc123def456",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_remove(self, async_client: AsyncBlooio) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `group_id` but received ''"):
            await async_client.groups.members.with_raw_response.remove(
                contact_id="%2B15551234567",
                group_id="",
            )
