...
class TestBackground:
    ...
    def test_method_retrieve(self, client: Blooio) -> None:
        background = client.chats.background.retrieve(
            "chatId",
        )
        assert_matches_type(ChatBackgroundResponse, background, path=["response"])

    @pytest.mark.skip(reason="Mock server tests are disabled")
    @parametrize
    def test_raw_response_retrieve(self, client: Blooio) -> None:
        response = client.chats.background.with_raw_response.retrieve(
            "chatId",
        )
    ...
    def test_streaming_response_retrieve(self, client: Blooio) -> None:
        with client.chats.background.with_streaming_response.retrieve(
            "chatId",
        ) as response:
    ...
    def test_path_params_retrieve(self, client: Blooio) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `chat_id` but received ''"):
            client.chats.background.with_raw_response.retrieve(
                "",
            )
...
class TestAsyncBackground:
    ...
    async def test_method_retrieve(self, async_client: AsyncBlooio) -> None:
        background = await async_client.chats.background.retrieve(
            "chatId",
        )
        assert_matches_type(ChatBackgroundResponse, background, path=["response"])
    ...
    async def test_raw_response_retrieve(self, async_client: AsyncBlooio) -> None:
        response = await async_client.chats.background.with_raw_response.retrieve(
            "chatId",
        )
    ...
    async def test_streaming_response_retrieve(self, async_client: AsyncBlooio) -> None:
        async with async_client.chats.background.with_streaming_response.retrieve(
            "chatId",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_retrieve(self, async_client: AsyncBlooio) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `chat_id` but received ''"):
            await async_client.chats.background.with_raw_response.retrieve(
                "",
            )
