...
class MeResourceWithRawResponse:
    ...
    def numbers(self) -> NumbersResourceWithRawResponse:
        """Manage phone numbers linked to your account"""
        return NumbersResourceWithRawResponse(self._me.numbers)
...
class AsyncMeResourceWithRawResponse:
    ...
    def numbers(self) -> AsyncNumbersResourceWithRawResponse:
        """Manage phone numbers linked to your account"""
        return AsyncNumbersResourceWithRawResponse(self._me.numbers)
...
class MeResourceWithStreamingResponse:
    ...
    def numbers(self) -> NumbersResourceWithStreamingResponse:
        """Manage phone numbers linked to your account"""
        return NumbersResourceWithStreamingResponse(self._me.numbers)
...
class AsyncMeResourceWithStreamingResponse:
    ...
    def numbers(self) -> AsyncNumbersResourceWithStreamingResponse:
        """Manage phone numbers linked to your account"""
        return AsyncNumbersResourceWithStreamingResponse(self._me.numbers)
